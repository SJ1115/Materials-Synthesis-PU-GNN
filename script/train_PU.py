...
parser.add_argument('--model_out', default='sample.pt', type=str,
...
parser.add_argument('--test_id', default='id_prop_test.csv', type=str,
                    help="filename of train.csv in data folder")
parser.add_argument('--test_csv', default='sample.csv', type=str,
                    help="filename of model out file in result folder")
...
trainer.PU_train(
        ...
        result_file=callpath("./result/model/" + option.model_out))
